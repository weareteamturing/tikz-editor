...
import { applyAdornmentSetProperty, applyAdornmentValueRewrite } from "./actions/adornment-set-property.js";
...
function applyJoinPaths(
  ...
  const elementIds = normalizeElementIds(action.elementIds);
